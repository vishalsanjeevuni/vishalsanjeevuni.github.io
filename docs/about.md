<div class="about-header">
  ...
  <a href="https://linkedin.com/in/vishal-sanjeevuni" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:vishalsanjeevuni@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I'm a **Data Engineer** based in Toronto, building production data pipelines, cloud infrastructure, and analytics systems.

With expertise in **Python**, **SQL**, and modern data tools like **dbt**, **Apache Airflow**, and **Kafka**, I specialize in designing scalable ETL/ELT pipelines that transform raw data into actionable insights.
...
**Open to interesting data engineering challenges** — let's build something great.
